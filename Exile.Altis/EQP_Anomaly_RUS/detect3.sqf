...
_title  = "<t color='#ff0000' size='1.2' shadow='1' shadowColor='#000000' align='center'> ВЫ ОБНАРУЖИЛИ АНОМАЛИЮ - ЖГУЧИЙ ПУХ: </t><br/><t color='#ffffff'>¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯<br/>";
...
if (_itemToLookFor in (uniformItems player)) then {
		...
		playSound "ffluff";
		uisleep 1;
			_htext   = "Вы успешно изучили аномалию Жгучий Пух и нанесли ее на карту. Найдите Бориса Бритву, и поговорите с ним. ";
