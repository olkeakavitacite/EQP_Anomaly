...
_title  = "<t color='#ff0000' size='1.2' shadow='1' shadowColor='#000000' align='center'> ВЫ НАШЛИ АНОМАЛИЮ С НАЗВАНИЕМ GRAVI: </t><br/><t color='#ffffff'>¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯¯<br/>";

_itemToLookFor = "MineDetector";
if (_itemToLookFor in (uniformItems player)) then {
		playSound "gravi";  
		uisleep 1;
			_htext   = "Вы успешно изучили GRAVI и получили за это награду.";
