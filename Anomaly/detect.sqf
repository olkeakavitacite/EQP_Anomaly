...
_itemToLookFor = "MineDetector"; // set quest item.

if (_itemToLookFor in (uniformItems player)) then { // detect quest item in player
				playSound "anm";   // play anomaly sound
				uisleep 5; // pause default 5 sec
